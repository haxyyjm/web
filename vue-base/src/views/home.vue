  ...
  <el-row class="container">
    ...
    <el-col :span="24" class="topbar-wrap">
      ...
      <div class="topbar-logos">
        <a href="/" style="color: #fff;"><span v-show="!$store.state.collapsed">首旅如家</span></a>
      </div>
      <div class="topbar-title">
        <el-row v-show="$store.state.topNavState==='home'"><!-- 注意：这里就是topNavState作用之处，根据当前路由所在根路由的type值判断显示不同顶部导航菜单 -->
          <el-col :span="24">
          <el-menu active-text-color="#fff" :default-active="activeIndex" class="el-menu-demo" mode="horizontal"   @select="handleSelect" :router="true">
              <el-menu-item index="/">首页</el-menu-item>
              <el-menu-item index="/orderList">订单</el-menu-item>
              <el-menu-item index="/houseStatus">房态</el-menu-item>
              <el-menu-item index="/houseControl">房控</el-menu-item>
               <el-menu-item index="/bill">现付账</el-menu-item>
              <el-menu-item index="/customer">客户</el-menu-item>
               <el-menu-item index="/reports">报表</el-menu-item>
              <el-menu-item index="/agreement">协议</el-menu-item>
               <el-menu-item index="/promotion">促销</el-menu-item>
              <el-menu-item index="/accountsReceivable">财务</el-menu-item>
               <el-menu-item index="/setting">设置</el-menu-item>
              <el-menu-item index="/work">工作台（有侧边栏）</el-menu-item>
              <el-menu-item index="/orderManager">订单管理（有侧边栏）</el-menu-item>
            </el-menu>
          </el-col>
        </el-row>
      </div>
